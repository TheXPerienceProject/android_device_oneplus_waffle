// libapsfixup.so — permanent native fix for the OnePlus(waffle) APS turbo soft/green/crash bug.
//
...
static const uintptr_t P010_FUNC_OFF = 0x58f688;   // p010LSB2MSBNeon in libAlgoProcess
